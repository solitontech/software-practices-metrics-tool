...
describe('AzureDevopsEntity~fetchAllBranches - returns all branches for repository', () => {
  afterEach(() => {
  ...
  it('should fetch all branches successfully when data is present in azure repository', async () => {
    ...
    const response = await AzureDevopsEntity.fetchAllBranches();
  ...
  it('should throw AppError with status 404 when no branches are found in azure repository', async () => {
    ...
    const response = AzureDevopsEntity.fetchAllBranches();
